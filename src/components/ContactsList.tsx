  ...
  const handleExportContacts = (format: 'xlsx' | 'csv') => {
    ...
    const exportData = filteredContacts.map(contact => {
      const baseData = {
        ...
        [t('contacts:list.export.usesScooters')]: contact.uses_scooters ? t('contacts:list.experienceOptions.yes') : t('contacts:list.experienceOptions.no'),
        [t('contacts:list.export.willingToAcquireScooters')]: contact.willing_to_acquire_scooters ? t('contacts:list.experienceOptions.yes') : t('contacts:list.experienceOptions.no'),
